...
const navItems: NavItem[] = [
  ...
  { label: "Contato Comercial", href: "#contato-comercial", id: "10" },
  { label: "Contato Diretoria", href: "#contato-diretoria", id: "11" },
];
        ...
        <div className="hidden lg:flex items-center gap-1">
          {navItems.map((item) => (
            <a
              ...
              className={`px-3 py-2 text-sm font-medium transition-all duration-300 hover:text-[#FF5722] ${
